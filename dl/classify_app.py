...
NON_FOOD_CATEGORIES = [
    ...
    "bottle", "wine glass", "cup", "fork", "knife", "spoon", "bowl", "potted plant", "chair", 
    "couch", "bed", "dining table", "toilet", "tv", "laptop", "mouse", "remote", "keyboard", 
        ...
        for result in results:
            for box in result.boxes:
                ...
                try:
                    ...
                    if label in NON_FOOD_CATEGORIES or label in seen_labels:
                        continue
